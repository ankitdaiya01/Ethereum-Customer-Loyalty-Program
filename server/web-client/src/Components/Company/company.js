...
import './company.css';
const loginUrl = `http://localhost:5000/api/enroll`;
const enrollEmp = `http://localhost:5000/api/enrollEmp`;
const addAddsUrl = `http://localhost:5000/api/addAd`;
...
// --------------  Enroll companies -----------------
    ...
    async loadCompanies() {
        ...
        var response = await ApiCaller.apiRequest({
            url: "http://localhost:5000/api/getCompamies",
            method: 'get',
                    ...
                    <div className="col-md-4 addad" id="add_ad">
                        <div className="login-form">
                            <form method="post" autoComplete="off">
                                ...
                                <div className="form-group">
                                <input  className="form-control" id="adPrice" type="number" placeholder="Ad Price" required="required" />
                            </div>
                                <div className="form-group">
